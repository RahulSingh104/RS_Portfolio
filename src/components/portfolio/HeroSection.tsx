            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                <div className="animate-fade-in">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
                       Passionate about building modern web apps using React, Node.js,Next.js and MongoDB.
                        Focused on writing clean code, solving real problems, and constantly learning.
                          Open to internships, freelance work, and exciting tech challenges!
                    ...
                    <div className="flex justify-center space-x-6 mb-16">
                        <a
                            href="https://github.com/RahulSingh104"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href="https://www.linkedin.com/in/rahul-singh-b57521229/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-3 rounded-none bg-card/50 backdrop-blur-sm border border-muted-foreground/20 hover:border-primary transition-all duration-300 hover:scale-110 group web-card"
                        >

...
const ContactSection = () => {
    const contactInfo = [
        {
            icon: Mail,
            label: "Email",
            value: "rajrahul04062004@gmail.com",
            href: "mailto:rajrahul04062004@gmail.com"
        },
        {
            icon: Phone,
            label: "Phone",
            value: "+91 96258 42591",
            href: "tel:+919625842591"
        },
        {
            icon: MapPin,
            label: "Location",
    ...
    const socialLinks = [
        { icon: Github, href: "https://github.com/RAHULSINGH104", label: "GitHub" },
        { icon: Linkedin, href: "https://www.linkedin.com/in/rahul-singh-b57521229/", label: "LinkedIn" },
            ...
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        ...
                        or just having a friendly chat about Frontend development,Backend Development, and innovation.
                    </p>
                </div>
                ...
                <div className="text-center mt-16 pt-8 border-t border-border/50">
                    <p className="text-muted-foreground">
                        © 2025 RAHUL KUAMR. Built with Vite, React, TypeScript & Tailwind CSS.
                    </p>
                </div>
            </div>
        </section>

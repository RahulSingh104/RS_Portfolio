...
export const badgeData = [
    {
        ...
        issuer: 'Cisco',
        date: 'Mar 12, 2024',
        link: 'https://www.credly.com/users/rahul-kumar.e5e433e8/badges#credly',
    },
    {
        id: 2,
...
const certificateData = [
    {
        ...
        issuer: 'Infosys',
        date: 'April 20, 2025',
        link: 'https://drive.google.com/drive/folders/1X4LyIemr4XWm6HZBQ1yw6pL5qJSNj5CD?usp=drive_link',
    },
    {
        id: 2,
    ...
    {
        id: 4,
        title: 'Flutter for complete beginners',
        issuer: 'freeCodeCamp',
        date: 'Aug 4, 2025',
        link: 'https://drive.google.com/drive/folders/1X4LyIemr4XWm6HZBQ1yw6pL5qJSNj5CD?usp=drive_link',
    },
        ...
        <section id="certifications" className="py-20 px-6 space-y-24">
            ...
            <div className="container mx-auto max-w-7xl">
                <div className="text-center mb-16">
                    ...
                    <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        Recognized course completions in ML, Android.
                    </p>
                </div>
            ...
            <div className="container mx-auto max-w-4xl text-center">
                <div className="text-center mb-10 mt-20">
                    ...
                    <p className="text-muted-foreground max-w-xl mx-auto">
                        During my internship at ICE TECHNOLOGY LAB, I had the opportunity to work on real-world projects
                        involving Frontend development, animation. I gained hands-on experience with
                        technologies like HTML, CSS, ANIMATED CSS, GSAP, and LOCOMOTIVE. I was involved in debugging production
                        environments, writing scalable code, and collaborating with senior developers to enhance the application
                        performance. This experience solidified my skills in software engineering, and team
                        collaboration and preparing me for full-time roles in FullStack Developer.
                    </p>
                </div>
